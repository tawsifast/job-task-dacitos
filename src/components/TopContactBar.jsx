      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          >
            ...
            <span className="hidden sm:inline">Info@amazepms.com</span>
          </a>
        ...
        <div className="flex items-center gap-1.5">
          {socials.map((s) => (
            <a
              ...
              className={`w-7 h-7 flex items-center justify-center rounded ${s.bg} ${s.hover} text-white transition-all`}
              aria-label={s.name}
            >
              {s.icon}
            </a>
